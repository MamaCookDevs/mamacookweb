...
const Header = () => {
  ...
  return (
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-headerColor">
      {/* desktop & tablet */}
          ...
          {isMenu && (
            ...
            >
             ...
             transition-all duration-100 ease-in-out text-textColor text-base"
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center justify-center gap-3 cursor-pointer bg-gray-200
