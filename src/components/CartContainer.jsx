...
import Shopping from "../img/woman-shopping-online.gif";
...
const CartContainer = () => {
  ...
  return (
    ...
    flex flex-col z-[101]'>
        <div className='w-full flex item-center justify-between p-4 cursor-pointer'>
            ...
            <p className='text-textColor text-lg font-semibold'>
                ...
                <motion.p
                whileTap={{scale: 0.75}} className='flex items-center gap-2 p-1 px-2 my-2 bg-gray-100 rounded-md
                hover:shadow-md  cursor-pointer text-textColor
                text-base' onClick={clearCart} >
                    Clear<RiRefreshFill /> {''}
        ...
        <div className='w-full h-full bg-cartBg rounded-t-[2rem] fel flex-col'>
                {/* cart items section */} 
    ...
    {/* cart total section  */}
    <div className='w-full flex-1 bg-cartTotal rounded-t-[2rem] felx flex-col items-center
    justify-evenly px-8 py-2'>
        ...
        <p className='text-gray-200 text-xl font-semibold'>${tot + 2.50}</p>
       ...
       {user ? (
         ...
         whileTap={{ scale: 0.8}}
         type="button"
         className='w-full p-2 rounded-full bg-cartNumBg text-gray-50
        ...
        text-lg my-2 hover:shadow-lg'>
            ...
            <div className="w-full h-full flex flex-col items-center justify-center gap-6">
              <img src={Shopping} className="w-300" alt="" />
